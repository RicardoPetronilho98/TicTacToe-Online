 ...
 */
public class JPlayGame extends javax.swing.JFrame {
     ...
     */
    public JPlayGame(BufferedReader br, PrintWriter pw) {
        initComponents();
        ...
        this.pw = pw;
        this.setJButonTable();   
        new Thread(new TableUpdaterJPlayGame(this)).start();
    }
    ...
    private void setJButonTable() {
        ...
        for(int l=0; l<this.buttons.length; l++)
            for(int c=0; c<this.buttons[l].length; c++)
                this.buttons[l][c].addActionListener( new JButtonActionListtener(l, c, this));
    }
