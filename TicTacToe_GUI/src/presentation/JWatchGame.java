 ...
 */
public class JWatchGame extends javax.swing.JFrame {
     ...
     */
    public JWatchGame(BufferedReader br, PrintWriter pw) {
        initComponents();
        
        this.setResizable(false);
        this.lcs = new ReentrantLock();
        this.br = br;
        this.pw = pw;
        this.setJButonTable();   
        new Thread(new TableUpdaterJWatchGame(this)).start();
    }
    
    private void setJButonTable() {
        this.buttons = new JButton[N][N];
        
        this.buttons[0][0] = this.jButton1;
        this.buttons[0][1] = this.jButton2;
        this.buttons[0][2] = this.jButton3;
        
        this.buttons[1][0] = this.jButton4;
        this.buttons[1][1] = this.jButton5;
        this.buttons[1][2] = this.jButton6;
        
        this.buttons[2][0] = this.jButton7;
        this.buttons[2][1] = this.jButton8;
        this.buttons[2][2] = this.jButton9;
    }
